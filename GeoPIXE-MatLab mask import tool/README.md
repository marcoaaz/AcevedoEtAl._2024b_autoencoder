...
This folder contains a script to convert a QuPath software mineral phase map 'region of interest' (ROI) into a GeoPIXE Q-vector file (readable as a region in GeoPIXE). It also contains the script to reproduce the figure below (see paper).
...
Description of script functionalities:
  ...
  + figureGeoPIXE_v2.m = script for generating spectral figures for Synchrotron XFM (for comparison). It supports GeoPIXE spectral output conventions
